...
содержит 580 словарных статей, а `sentences.jsonl` — 450 предложений (225 A1 и 225 A2).
Импорт создаёт 1350 упражнений.
...
фильтры очереди и полную разметку 450 предложений. Android export проверяет сборку bundle,
